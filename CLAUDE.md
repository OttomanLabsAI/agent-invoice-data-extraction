...
Working and checked: full app, smoke test green, packaged copy boots and serves, Gmail OAuth connected end to end from the Settings page on Fid's machine.
...
- Before every push: `python tests/smoke_test.py` green, start the app and click through Inbox -> sample upload -> review -> Settings, and confirm `git status` shows nothing under `data/`.

### Release ledger

| Tag | Date | Summary |
|---|---|---|
| _(none yet - repo not initialised; first push is v1.0)_ | | |
